...
#SBATCH --job-name=grpo_cls_noreasoning_qwen35
#SBATCH --output=grpo_cls_noreasoning-%j.out
#SBATCH --error=grpo_cls_noreasoning-%j.err
...
export WANDB_RUN_NAME=Qwen3.5-VL-CLS-NoReasoning-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
