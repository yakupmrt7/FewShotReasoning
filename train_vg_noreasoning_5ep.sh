...
#SBATCH --job-name=grpo_vg_noreasoning_5ep_qwen35
#SBATCH --output=grpo_vg_noreasoning_5ep-%j.out
#SBATCH --error=grpo_vg_noreasoning_5ep-%j.err
...
export WANDB_RUN_NAME=Qwen3.5-VL-VG-NoReasoning-5ep-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
