...
#SBATCH --job-name=grpo9b_cotf_vg
#SBATCH --output=grpo9b_cotf_vg-%j.out
#SBATCH --error=grpo9b_cotf_vg-%j.err
...
export WANDB_RUN_NAME=9B-Filtered-VG-cot-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
echo "Base model: qwen35-9b-cot-vg-merged"
...
python -u -m torch.distributed.run \
    ...
    --model_name_or_path /arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-9b-cot-vg-merged \
