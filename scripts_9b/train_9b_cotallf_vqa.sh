...
#SBATCH --job-name=grpo9b_cotallf_vqa
#SBATCH --output=grpo9b_cotallf_vqa-%j.out
#SBATCH --error=grpo9b_cotallf_vqa-%j.err
...
export WANDB_RUN_NAME=9B-Filtered-VQA-cotall-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
echo "Base model: qwen35-9b-cotall-vqa-merged"
...
python -u -m torch.distributed.run \
    ...
    --model_name_or_path /arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-9b-cotall-vqa-merged \
