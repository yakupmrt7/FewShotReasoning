...
#SBATCH --job-name=grpo9b_cotallf_cls
#SBATCH --output=grpo9b_cotallf_cls-%j.out
#SBATCH --error=grpo9b_cotallf_cls-%j.err
...
export WANDB_RUN_NAME=9B-Filtered-CLS-cotall-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
echo "Base model: qwen35-9b-cotall-cls-merged"
...
python -u -m torch.distributed.run \
    ...
    --model_name_or_path /arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-9b-cotall-cls-merged \
    --dataset_name /arf/scratch/aalatan/grpo_data/VHM_dataset_grpo_cls_only_2k_refactored_filtered \
