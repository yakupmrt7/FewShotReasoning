...
#SBATCH --job-name=grpo9b_cotf_cls
#SBATCH --output=grpo9b_cotf_cls-%j.out
#SBATCH --error=grpo9b_cotf_cls-%j.err
...
export WANDB_RUN_NAME=9B-Filtered-CLS-cot-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
echo "Base model: qwen35-9b-cot-cls-merged"
...
python -u -m torch.distributed.run \
    ...
    --model_name_or_path /arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-9b-cot-cls-merged \
