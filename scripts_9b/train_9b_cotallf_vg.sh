...
#SBATCH --job-name=grpo9b_cotallf_vg
#SBATCH --output=grpo9b_cotallf_vg-%j.out
#SBATCH --error=grpo9b_cotallf_vg-%j.err
...
export WANDB_RUN_NAME=9B-Filtered-VG-cotall-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
echo "Base model: qwen35-9b-cotall-vg-merged"
...
python -u -m torch.distributed.run \
    ...
    --model_name_or_path /arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-9b-cotall-vg-merged \
    --dataset_name /arf/scratch/aalatan/grpo_data/VHM_dataset_grpo_vg_only_2k_filtered \
