#!/bin/bash
# Submit all VQA evaluation tasks for a given model
# Usage: ./eval_all_vqa.sh
# Only change MODEL_PATH below!

MODEL_PATH="/arf/scratch/aalatan/FewShotReasoning/train/checkpoints/Qwen-VL-2B-GRPO-VQA-CoT-Balanced-MiddleGround-2026-01-26-16-55-56/final"
...
# All VQA tasks
VQA_TASKS=("vqa_HR-comp" "vqa_HR-pre" "vqa_LR-comp" "vqa_LR-pre" "vqa_LR-rural")
...
echo "=========================================="
echo "Submitting VQA evaluation jobs"
echo "Model: $MODEL_NAME"
echo "Model Path: $MODEL_PATH"
echo "=========================================="

for TASK in "${VQA_TASKS[@]}"; do
