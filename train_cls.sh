...
#SBATCH --job-name=grpo_cls_qwen35
#SBATCH --output=grpo_cls-%j.out
#SBATCH --error=grpo_cls-%j.err
...
export WANDB_RUN_NAME=Qwen3.5-VL-CLS-GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
echo "Dataset: VHM_dataset_grpo_cls_only_2k_refactored (CLS-only, 634 examples, answer_type=1 exact-match)"
echo "=============================="
